import argparse, logging, pathlib, wandb, requests, tempfile 
...
if __name__ == "__main__":
    ...
    #parser.add_argument("--sample", type=str, help="sample csv file", required=True)
    parser.add_argument("--file_url", type=str, help="File URL", required=True)
    parser.add_argument(
        "--artifact_name", type=str, help="Name for artifact", required=True)
    parser.add_argument("--artifact_type", type=str, help="Type", required=True)
